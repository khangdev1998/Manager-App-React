...
const ImportExportHistoryPage = () => {
  return (
    <>
      <div className="tools">
        <div className="d-flex align-items-stretch flex-wrap gap-2">
          <button className="tools-add" type="button">
          ...
          <button className="tools-button">
            ...
            Tạo phiếu kiểm theo mã sản phẩm
          </button>
          <button className="tools-button">
            <svg
              viewBox="64 64 896 896"
            ...
            Nhập Excel tạo phiếu kiểm hàng
          </button>
          <button className="tools-button">
            Thao tác
...
export default ImportExportHistoryPage;
